...
############################################################################################
    ...
    ###  published in Wietz et al. ISME Comms
    ###  doi:
...
# NOTE: imported ASVs cover 4 datasets 
# Only ASVs from moorings F4 and EGC analyzed here
...
# for EUKs: delete superphylum taxrank
TAX.euk <- TAX.euk.raw %>%
...
ENV$month <- factor(ENV$month, levels=c(
  "Aug","Sep","Oct","Nov","Dec","Jan",
  "Feb","Mar","Apr","May","Jun","Jul"))
ENV$watermass <- factor(ENV$watermass, levels=c(
  "AW","PW","mix"))
