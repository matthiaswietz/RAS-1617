...
plot_fam1 <- amp_heatmap(
  ...
  tax_show = c(
    "RAD-C_ucX","RAD-B-Group-IV",
    "Dino-II-7","Dino-I-1",
    "Opalinopsidae","Pelagomonadaceae",
    "Heterocapsaceae","Pelagophyceae_uc",
    "Pirsonia_Clade_uc","MAST-3I_uc",
  ...
  order_y_by = c(
    "Pirsonia_Clade_uc","MAST-3I_uc",
    "RAD-C_ucX","Dino-II-7","Dino-I-1",
    "RAD-B-Group-IV","Opalinopsidae",
    "Pelagomonadaceae","Heterocapsaceae",
    "Pelagophyceae_uc","Coscinodiscophyceae",
...
plot_fam2 <- amp_heatmap(
  ...
  tax_show = c(
    ...
    "Cryomorphaceae","SAR11_Clade_I",
    "Flavobacteriaceae","SAR86_clade_uc"),
  order_y_by = c(
...
plot_trans2 <- sum.genus %>% filter(
  site=="WSC" & Genus %in% c(
    ...
    "Chytridiomycetes_uc","SAR92_clade",
    "Labyrinthulaceae_uc","Aurantivirga",
    "Dino-I-1_uc","Dino-II-7_uc") 
  & season !="summer") %>%
  ungroup %>%
...
sum.genus %>%
  filter(site=="EGC" & Genus %in% c(
    "Nitrospina","Magnetospiraceae_uc",
    "Aurantivirga","RAD-B-Group-IV_uc",
    "Phaeocystis","OCS116_clade_uc",
    "Thalassiosira","Novel-clade-2_uc",
    "Colwellia","Marinimicrobia_SAR406_uc")) %>%
...
scale_x_discrete(limits=c(
  "Colwellia","Marinimicrobia_SAR406_uc",
  "RAD-B-Group-IV_uc","Magnetospiraceae_uc",
  "Nitrospina","OCS116_clade_uc",
  "Aurantivirga","Novel-clade-2_uc",
...
plot_summer11 <- ggplot(data=subset(
  summer1, locus_tag=="16S"), aes(
    x=date, y=Abundance, fill=Genus,group=Genus)) +
geom_area(size=1) +
scale_fill_manual(
...
facet_wrap(
  ~Genus, ncol=1, 
  scale="free", strip.position = "right")+
theme_classic() +
theme(axis.title=element_blank(),
        #strip.placement = "outside",
        axis.text.x=element_blank(),
...
summer2 <- sum.genus %>%
  filter(site=="EGC" & month %in% c(
   ...
   "OCS116_clade_uc","Cryomorphaceae_uc",
