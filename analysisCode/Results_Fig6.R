...
plot_night2 <- avg.month %>%
  filter(Genus %in% c(
    ...
    "Corethron","Tripos","RAD-C uc",
    "Dino-I-1 uc","Bacillaria",
    "Dino-II-7 uc","Naviculales",
    "SAR116 uc","Cand_Puniceispirillum",
    "Amylibacter","Planktomarina","Polarella",
    "Ascidiaceihabitans","Luteolibacter",
    "Flavobacterium","Chrysophyceae C uc",
    "Cand_Nitrosopumilus","Magnetospira",
    "Magnetospiraceae uc","Chaetoceros",
    "Gammaproteobacteria uc","Colwellia",
    "Arctic97B-4 uc","Marinimicrobia_SAR406 uc") & 
      season %in% c(
        "autumn","winter"))  %>% 
  mutate(Genus2 = case_when(
    Genus %in% c(
      "Dino-I-1 uc",
      "Dino-II-7 uc")~'Syndiniales',
    Genus %in% c(
      "Chrysophyceae C uc",
